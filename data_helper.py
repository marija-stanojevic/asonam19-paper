...
class DataHelper():
    def __init__(self, sequence_max_length=1024):  # 1024
    ...
    def char2vec(self, text):
        ...
        for i in range(0, len(text)):
            if i >= self.sequence_max_length:  # we added
                return data
    ...
    def load_dataset(self, dataset_path):
        ...
        test_data, test_label = self.load_csv_file(dataset_path + 'cv.csv', num_classes)
        return train_data, train_label, test_data, test_label

    def load_unlabeled_data(self, dataset_path):
        # Read CSV Info
